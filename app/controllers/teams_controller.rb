class TeamsController < ApplicationController
  ...
  def leaderboard
    ...
    @options[:force] = true unless leaderboard_params[:refresh].blank?
    if signed_in?
  ...
  def show
    ...
    respond_to do |format|
      ...
      format.json do
        ...
        options[:force] = true unless show_params[:refresh].blank?
  ...
  def create
    ...
    if @team.valid? && @teams.blank? && @team.new_record?
  ...
  def fake_visitors
    ...
    5.times do
      ...
      v << { exit_url: 'http://heroku.com', exit_target_type: 'company-website', furthest_scrolled: 'challenges', time_spent: '2016', user_id: 1736, visited_at: 1_346_913_596, user: user, visits: 3 }
    end
    v
  end
