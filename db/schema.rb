...
ActiveRecord::Schema.define(version: 20_140_713_193_201) do
  ...
  add_index 'badges', %w(user_id badge_class_name), name: 'index_badges_on_user_id_and_badge_class_name', unique: true
  ...
  add_index 'endorsements', %w(endorsed_user_id endorsing_user_id specialty), name: 'only_unique_endorsements', unique: true
  ...
  add_index 'follows', %w(followable_id followable_type follower_id), name: 'follows_uniq_followable_id_type_follower', unique: true
  ...
  add_index 'github_assignments', %w(github_username badge_class_name), name: 'index_assignments_on_username_and_badge_class_name', unique: true
  add_index 'github_assignments', %w(github_username repo_url tag), name: 'index_assignments_on_username_and_repo_url_and_badge_class_name', unique: true
  ...
  add_index 'likes', %w(likable_id likable_type user_id), name: 'index_likes_on_user_id', unique: true
  ...
  add_index 'skills', %w(deleted user_id), name: 'index_skills_on_deleted_and_user_id'
  ...
  add_index 'tokens', %w(kind user_id), name: 'index_tokens_on_kind_and_user_id', unique: true
