# == Route Map
#                             GET     /.json(.:format)                                       #<Proc:0x000000053c7058@/vagrant/config/routes.rb:306>
#                             GET     /teams/.json(.:format)                                 #<Proc:0x000000053cd520@/vagrant/config/routes.rb:307>
...
#                authenticate GET     /auth/:provider/callback(.:format)                     sessions#create
