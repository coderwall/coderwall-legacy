...
VCR.configure do |c|
  ...
  c.filter_sensitive_data('<TWITTER_API_KEY>')             { ENV['TWITTER_API_KEY'] }
  c.filter_sensitive_data('<TWITTER_API_SECRET>')          { ENV['TWITTER_API_SECRET'] }
  ...
  c.filter_sensitive_data('<TWITTER_OWNER>')               { ENV['TWITTER_OWNER'] }
  c.filter_sensitive_data('<TWITTER_OWNER_ID>')            { ENV['TWITTER_OWNER_ID'] }
