...
RSpec.describe Changelogd, type: :model do
  ...
  it 'should find the first and last project', functional: true, slow: true, skip: 'The ChangeLog API integration is deprecated' do
  ...
  it 'should find repos in episodes too', functional: true, skip: 'The ChangeLog API integration is deprecated' do
