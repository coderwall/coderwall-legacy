...
//
        ...
        //replace slideshare with iframe
        text = text.replace(/(https?:\/\/www\.slideshare\.net\/slideshow\/embed_code\/\d+)/, "<iframe src='$1' class='slideshare'></iframe>");
        ...
        text = text.replace(/https?\:\/\/[^"\s\<\>]*[^.,;'">\:\s\<\>\)\]\!]/g, function (wholeMatch, matchIndex) {
            ...
            return "<a href='" + href + "' target='_blank'>" + wholeMatch + "</a>";
        });
